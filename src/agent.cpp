...
std::string Agent::build_system_prompt() const
{
    std::string prompt =
        ...
        "IMPORTANTE: apri e chiudi SEMPRE i blocchi di codice con ``` (3 backtick).\n"
        "Un code block non chiuso rende illeggibile tutto il testo successivo.\n\n"
        "Dopo il risultato, continua la conversazione.\n"
        "Se non servono strumenti, rispondi normalmente.\n"
        "\n"
        "=== REGOLE DI EDITING (PRIORITARIO) ===\n"
        "1. Per MODIFICARE file esistenti, USA SEMPRE 'diff_apply' con formato unified diff.\n"
        "   NON usare 'write' per modificare — sovrascrive tutto il file.\n"
        "   NON usare 'edit' per cambiamenti complessi — diff_apply è più sicuro.\n"
        "2. Il formato diff:\n"
        "   @@ -L,C +L,C @@\n"
        "    riga di contesto (deve matchare ESATTAMENTE)\n"
        "   -riga da rimuovere\n"
        "   +riga da aggiungere\n"
        "    riga di contesto\n"
        "3. Per CREARE nuovi file, usa 'write'.\n"
        "4. Prima di qualsiasi modifica, USA 'read' per leggere il file.\n"
        "5. Includi ABBASTANZA contesto nel diff (2-3 righe prima e dopo la modifica).\n"
        "Pensa passo-passo.\n";
